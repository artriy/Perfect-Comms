...
Capture, playback, DSP (WebRTC-APM AEC3/high noise suppression/HPF), Opus codec, and WebRTC (webrtc-rs) peer transport with proximity mixing. Loopback 127.0.0.1 single client, token via stdin (native) or token-file (Wine), protocol version 8.
