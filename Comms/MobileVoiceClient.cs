...
internal sealed class MobileVoiceClient : IDisposable
{
    ...
    private static void LogMobileDiagnostics(string json)
    {
        ...
        VoiceDiagnostics.Log("voice.mobile.native",
            ...
            $"mixControlPeers={ReadUInt64(root, "mix_control_peers")} mixControlAttenuatedPeers={ReadUInt64(root, "mix_control_attenuated_peers")} mixControlBoostedPeers={ReadUInt64(root, "mix_control_boosted_peers")} mixControlOverloadPeers={ReadUInt64(root, "mix_control_overload_peers")} mixControlClippingPeers={ReadUInt64(root, "mix_control_clipping_confident_peers")} " +
            $"mixControlMaxAttenuationDb={ReadFiniteDouble(root, "mix_control_max_attenuation_db"):0.00} mixControlMaxMakeupDb={ReadFiniteDouble(root, "mix_control_max_makeup_db"):0.00} mixControlPeakReductionDb={ReadFiniteDouble(root, "mix_control_max_peer_peak_reduction_db"):0.00} mixControlActiveLevelDb={ReadFiniteDouble(root, "mix_control_loudest_active_level_db"):0.00} mixControlNoiseLevelDb={ReadFiniteDouble(root, "mix_control_highest_noise_level_db"):0.00} mixLimiterReductionDb={ReadFiniteDouble(root, "mix_control_output_limiter_reduction_db"):0.00} mixLimiterDetectedPeak={ReadFiniteDouble(root, "mix_control_output_limiter_detected_peak"):0.000000} mixLimiterLimitedSamples={ReadUInt64(root, "mix_control_output_limiter_limited_samples")} mixLimiterEvents={ReadUInt64(root, "mix_control_output_limiter_reduction_events")} " +
