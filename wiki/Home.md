...
Proximity voice chat built directly into Among Us.
...
- **[Mod Integration](Mod-Integration)** - start here: safe soft-dependency setup and the complete API 1.2 behavior.
