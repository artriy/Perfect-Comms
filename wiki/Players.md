...
| **Keybinds** | Every voice action, modifier chords, alive/dead hold-mix levels, refresh actions, and player volumes. |
...
See [Player Settings & Controls](Controls) for every option, default, keybind, and Android control.
